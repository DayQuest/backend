...
public class FollowService {
    ...
    @Async
    @CacheEvict(value = "followRelationships", allEntries = true)
    ...
    @Async
    @Cacheable(value = "followRelationships", key = "#userId + ':' + #userToCheckId")
    ...
    @Async
    @Cacheable(value = "followRelationships", key = "#token + ':followed:' + #page + ':' + #size")
    ...
    @Async
    @Cacheable(value = "followRelationships", key = "#token + ':followers:' + #page + ':' + #size")
